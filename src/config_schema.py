...
class Settings(SettingsEntityModel):
    ...
    cors_allow_origins_regex: str = "^(https://innohassle\.ru|https://\w+\.innohassle\.ru|https://local\.innohassle\.ru(:30[0-9][0-9])?|http://localhost(:30[0-9][0-9])?):http://127\.0\.0\.1(:30[0-9][0-9])?)$"
